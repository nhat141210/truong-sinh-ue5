...
| ACT-001 | Shared activity pipeline | Cultivation mẫu Plan→Resolve→Commit→Present | SOURCE_ONLY |
| ACT-002 | Replay safety | 1x/2x/skip/missing cue cùng result; load không reroll | NOT_STARTED |
| CULT-001 | Tu luyện/đột phá | Tu vi/time/lifespan thay đổi deterministic | NOT_STARTED |
