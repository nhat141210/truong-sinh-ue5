...
required_docs=(
  00_START_HERE 01_PRODUCT_BRIEF 02_PARITY_CONTRACT 03_REFERENCE_VERSION
  04_REFERENCE_AUDIT_GUIDE 05_PARITY_MATRIX 06_GAME_DESIGN_DOCUMENT
  07_SYSTEM_RULEBOOK 08_COMBAT_SPEC 09_CONTENT_CATALOG 10_UI_UX_SPEC
  ...
  17_MATERIAL_LIGHTING_VFX 18_3D_COMBAT_PRESENTATION 19_PERFORMANCE_BUDGET
...
for template in FEATURE_AUDIT_TEMPLATE COMBAT_EXPERIMENT_TEMPLATE CONTENT_ENTRY_TEMPLATE QUEST_AUDIT_TEMPLATE VISUAL_REVIEW_TEMPLATE; do
...
required_foundation_sources=(
  ...
  Source/TruongSinhSave/Public/Save/TruongSinhSaveGameV1.h
  Source/TruongSinhSave/Private/Save/TruongSinhSaveGameV1.cpp
...
canonical_modules=(
  Source/TruongSinhCore Source/TruongSinhSimulation Source/TruongSinhCombat
  Source/TruongSinhQuest Source/TruongSinhSave
)
...
for test_name in \
  ...
  TruongSinh.Save.RoundTripV1; do
